    ...
    async componentDidUpdate(){
        try {
            ...
            if(this.state.sort === 'price'){
                const result = await axios.get('http://localhost:8000/product/?sort=price&order=desc&limit=12')
                console.log(result);
                this.setState({
                    product : result.data.data
                })
        ...
        <>
            ...
            <div className="productFilter col-lg-12">
                ...
                <select name="price" id="price">
                    <option value="price" onClick={()=>{
                        this.setState({
                            sort : 'price'
                        })
                    }}>Price</option>
                    <option value="latest" onClick={()=>{
                        this.setState({
                            sort : 'latest'
                        })
                    }}>Latest</option>
...
export default withSearchParams(withParams(Productsss))